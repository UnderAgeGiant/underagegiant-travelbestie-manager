...
function buildApp() {
  ...
  app.use('/trips', createTripsRouter(new TripController(new MemoryTripRepository()), karmaRepo));
...
describe('POST /trips', () => {
  it('creates a trip with stops and transits and applies karma −1', async () => {
